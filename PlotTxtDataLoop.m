%PlotTxtdata2("paperReady_CN40_referenceSetting_diffusion", "paperReady_CN40_referenceSetting_diffusion")
%PlotTxtdata2("paperReady_CN40_referenceSetting_diffusion_kaiser", "paperReady_CN40_referenceSetting_diffusion_kaiser")
%PlotTxtdata2("paperReady_CN40_referenceSetting_diffusion_zech", "paperReady_CN40_referenceSetting_diffusion_zech")

%PlotTxtdata2("paperSimulation_CN40_referenceSetting_moreMBspots","paperSimulation_CN40_referenceSetting_moreMBspots")

%PlotTxtdata2("paperSimulation_CN40_referenceSetting_2", "paperReady_CN40_referenceSetting_2")


PlotTxtdata2("paperSimulation_CN40_referenceSetting", "paperReady_CN40_referenceSetting")

files = ["paperSimulation_CN40_referenceSetting", "paperSimulation_referenceSetting_CN40_without_particle_Movement"];
names_appendix = [" Sc.1Full"," Sc.1Stat"];
PlotTxtdataCompare(files, "paperSimulation_compareParticleMovement", names_appendix)

PlotTxtdata2("paperSimulation_referenceSetting_CN40_without_particle_Movement", "paperSimulation_referenceSetting_CN40_without_particle_Movement")

files = ["paperSimulation_CN10_referenceSetting","paperSimulation_CN22_referenceSetting",...
    "paperSimulation_CN40_referenceSetting", "paperSimulation_CN100_referenceSetting", ...
    "paperSimulation_CN40_referenceSetting_exudationDays"];
names_appendix = [" CN10", " CN22", " CN40", " CN100", " 10\cdotCN40"];
PlotTxtdataCompare(files, "paperSimulation_compareAll", names_appendix)

files = ["paperSimulation_CN10_referenceSetting","paperSimulation_CN22_referenceSetting",...
    "paperSimulation_CN40_referenceSetting", "paperSimulation_CN100_referenceSetting"];
names_appendix = [" CN10", " CN22", " CN40", " CN100"];%," CN100"
PlotTxtdataCompare(files, "paperSimulation_compareExudateQuality", names_appendix)


files = ["paperSimulation_CN40_referenceSetting", "paperSimulation_CN10_referenceSetting","paperSimulation_CN40_referenceSetting_exudationDays"];
names_appendix = [" CN40"," CN10"," 10days CN40"];
PlotTxtdataCompare(files, "paperSimulation_compareExudateTiming", names_appendix)
...
% PlotTxtdataCompare_Adrian(files, "compareExudateTiming", names_appendix)
% % % 
% % 
% % % 
% 
% %PlotTxtdata2("paperReady_referenceSetting_CN40_without_particle_Movement", "paperReady_CN40_referenceSetting_CN40_without_particle_Movement")
% 
