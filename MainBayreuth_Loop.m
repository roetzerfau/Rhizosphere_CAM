...
%Main_Bayreuth3(true,40,[200], "paperSimulation_CN40_referenceSetting_moreMBspots",true, 0.5, 10, 0.0001);
Main_Bayreuth3(true,40,[200], "paperSimulation_CN40_referenceSetting_2",true, 0.5, 10, 0.0001);
% 
% parpool(4)
% parfor i = 1:4
%     if(i == 1)
%     Main_Bayreuth3(false,40,[200], "paperSimulation_referenceSetting_CN40_without_particle_Movement",true, 0.5, 10, 0.0001);
%     end
%     if(i == 2)
%     Main_Bayreuth3(true,40,[200], "paperSimulation_CN40_referenceSetting",true, 0.5, 10, 0.0001);
%     end
%     if(i == 3)
%     Main_Bayreuth3(true,40,exudatesDays, "paperSimulation_CN40_referenceSetting_exudationDays",true, 0.5, 10, 0.0001);
%     end
% 
% end
% parfor i = 1:3
%     if(i == 1)
%     Main_Bayreuth3(true,10,[200], "paperSimulation_CN10_referenceSetting",true, 0.5, 10, 0.0001);
%     end
%     if(i == 2)
%     Main_Bayreuth3(true,22,[200], "paperSimulation_CN22_referenceSetting",true, 0.5, 10, 0.0001);
%     end
%     if(i == 3)
%        Main_Bayreuth3(true,100,[200], "paperSimulation_CN100_referenceSetting",true, 0.5, 10, 0.0001);
%     end
% end


%nohup matlab -nojvm -singleCompThread -r "run('MainBayreuth_Loop.m');exit;" > output.log 2>&1 &
%Main_Bayreuth3(false,40,[200], "paperSimulation_referenceSetting_CN40_without_particle_Movement",true, 0.5, 10, 0.0001);
%Main_Bayreuth3(true,40,exudatesDays, "paperSimulation_CN40_referenceSetting_exudationDays",true, 0.5, 10, 0.0001);
% Main_Bayreuth3(true,10,[200], "paperSimulation_CN10_referenceSetting",true, 0.5, 10, 0.0001);
% Main_Bayreuth3(true,22,[200], "paperSimulation_CN22_referenceSetting",true, 0.5, 10, 0.0001);
