...
%inputMat = 'Input/loam_bayreuth_agg.mat';
...
output_file = '/home.local/roetzer/output_cam_rhizo/test/';
...
% parameter           mucilageConcVector(overshootConcInd(i)) =  evenDistributedAmount;s.rootGrowingRate = 1;
...
parameters.mucilageDecayRate = 1;%3.1/6.5;%7.9398;%0.22;%2.3026 ->sum/0.22  3.1
parameters.normalMucilageConcentration = 1;%6.5;%-> immer kleiner als 0.005 *1.3 in rhizisphre
criticialValue = parameters.normalMucilageConcentration * 1.5;
parameters.constantMucilageDeposition = 333.8;
extraConcAmount = 0;
TrootGrowingBegin = 1;
TrootGrowingEnd = 11;%87;%80
TrootShrinkingBegin = 1000;
TrootShrinkingEnd = 1300;
TmucilageGrowingBegin = 0;
TmucilageGrowingEnd = 13;%80
k_start = 0;
