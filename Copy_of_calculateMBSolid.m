...
%     a = 1.4 * exp(-0.25);
   ...
   if(abs(previousConcentration_C - currentConcentration_C) > 10^-7)
   ...
   if(abs(previousConcentration_N - currentConcentration_N) > 10^-7)
...
function dYdt = MMKfunction(t,Y, parameters)
   ...
   % C_S
    ...
    G = U - R_GE - R_M - R_O ;%- BD - EXT TODO check
    CUE = G/U;
