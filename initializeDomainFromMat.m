...
% load(inputMat);
bulkVector = (bulkVector);
bulkTypeVector = (bulkTypeVector);
edgeChargeVector = (edgeChargeVector);
particleTypeVector = (particleTypeVector);
POMconcVector = (POMconcVector);
POMVector = (POMVector);
reactiveSurfaceVector = (reactiveSurfaceVector);
